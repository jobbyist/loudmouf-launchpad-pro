...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "https://github.com/user-attachments/assets/60d3b1e6-7ea0-4337-a555-c0a45137b4f9" },
      { rel: "icon", href: "/favicon.ico" },
      { rel: "apple-touch-icon", href: "https://github.com/user-attachments/assets/60d3b1e6-7ea0-4337-a555-c0a45137b4f9" },
    ],
  }),
