  ...
  head: () => ({
    meta: [
      ...
      { title: "LOUDMOUF™ — Private Lifestyle Club · Big Taste. Zero Smoke." },
      {
        name: "description",
        content:
          "LOUDMOUF™ is South Africa's Private Lifestyle Club for premium cannabis pouches. Standard R99 or Premium R249 monthly membership. 18+ Members only.",
      },
      ...
      { property: "og:image:height", content: "1024" },
      {
        ...
        content: "LOUDMOUF™ cannabis pouches — Cheesecake, Bubblegum & Blueberry",
      },
