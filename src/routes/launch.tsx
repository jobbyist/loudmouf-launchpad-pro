  ...
  head: () => ({
    meta: [
      { title: "The Loudmouf Launch · Members-Only Event · RSVP" },
      {
        name: "description",
        content:
          "Reserve your spot for the official Loudmouf private members club launch event. Discreet. Intimate. Unforgettable.",
      },
      { property: "og:title", content: "The Loudmouf Launch · Members Only" },
      {
        property: "og:description",
        content: "Reserve your spot for the official Loudmouf launch event.",
      },
    ],
  }),
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          ...
          >
            ...
            <p className="mt-5 max-w-2xl text-white/70 text-base sm:text-lg">
              ...
              curated tastings, and the first-ever public unveiling of Drop 001. RSVP is required —
              ...
              {done ? (
                <div className="text-center py-10">
                  ...
                  <p className="mt-3 text-sm text-white/60">
                    We'll send location details and event kit info to your inbox closer to the date.
                  </p>
                  <Link
                    to="/"
                    className="mt-6 inline-flex items-center rounded-full border border-white/20 bg-white/5 px-5 py-2.5 text-xs uppercase tracking-widest text-white"
                  >
                    Back to home
                  </Link>
                </div>
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-white/50">
                      Non-transferable. We'll confirm within 48 hours.
                    </p>
                  </div>
                  <div>
                    <Label
                  ...
                  <Button
                    type="submit"
                    disabled={submitting}
                    className="cta-gradient w-full text-black uppercase tracking-widest text-xs font-semibold"
                  >
                    {submitting ? "Submitting…" : "Confirm My RSVP"}
                  </Button>
                  <p className="text-[10px] text-center uppercase tracking-widest text-white/40">
                    By RSVPing you confirm you are 18+ and understand this is a private members
                    event.
                  </p>
                </form>
              )}
