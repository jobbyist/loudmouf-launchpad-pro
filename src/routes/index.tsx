    ...
    <div className="relative min-h-screen overflow-x-clip bg-background text-foreground">
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {[
            { n: "01", icon: Package, t: "Reserve", c: "Reserve your tin from Drop 001 with secure checkout via Shopify." },
            { n: "02", icon: Sparkles, t: "Production", c: "Your tin is lab-tested, packed and readied at our Cape Town facility." },
            { n: "03", icon: Truck, t: "Delivery", c: "The our delivery partner delivers discreetly in 3–5 working days across SA." },
          ].map((s, i) => (
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <Accordion type="single" collapsible className="mt-12 space-y-3">
            {[
              ...
              { q: "Where do you deliver?", a: "Anywhere in South Africa via The our delivery partner. Standard delivery is 3–5 working days for a flat R150 fee. Free delivery on orders over R800." },
